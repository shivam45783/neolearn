      ...
      <tr>
        <td align="center" style="padding: 40px 0;">
          <table class="container" width="100%" cellpadding="0" cellspacing="0" border="0"
            style="max-width: 500px; background: #1f2937; border-radius: 15px; padding: 30px; text-align: center; font-family: 'Segoe UI', sans-serif; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.25);">
            <tr>
              <td>
                <img src="${logoURL}" alt="NeoLearn Logo" width="70" style="margin-bottom: 20px;" />
                <h2 class="title" style="font-size: 24px; font-weight: 700; color: #fff; margin: 0 0 15px;">OTP Verification</h2>
